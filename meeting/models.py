...
class Meeting(TimeStampedModel):
    ...
    admins = models.ManyToManyField(to=PracticeStaff, blank=True, related_name="admin")
    doctors = models.ManyToManyField(to=PracticeStaff, blank=True, related_name="staff")
