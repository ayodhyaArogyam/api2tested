...
class HrSettings(TimeStampedModel):
    practice = models.ForeignKey(to=Practice, null=True, blank=True, on_delete=models.PROTECT)
...
class UserTasks(TimeStampedModel):
    assignee = models.ForeignKey(to=get_user_model(), related_name="task_user", on_delete=models.PROTECT)
    reporter = models.ForeignKey(to=get_user_model(), related_name="task_reporter", on_delete=models.PROTECT)
    deadline = models.DateTimeField(null=True, blank=True)
    completed_on = models.DateTimeField(null=True, blank=True)
    completed_by = models.ForeignKey(to=get_user_model(), null=True, blank=True, related_name="task_completed",
    ...
    priority = models.ForeignKey(to=HrSettings, null=True, blank=True, on_delete=models.PROTECT)
    is_recurring = models.BooleanField(default=False)
    is_active = models.BooleanField(default=True)


class TaskTemplates(TimeStampedModel):
    department = models.ForeignKey(to=HrSettings, related_name="task_department", on_delete=models.PROTECT)
    designation = models.ForeignKey(to=HrSettings, related_name="task_designation", on_delete=models.PROTECT)
