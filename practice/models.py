...
class PracticeStaff(TimeStampedModel):
    ...
    department = models.ForeignKey("muster_roll.HrSettings", blank=True, related_name="department", null=True,
                                   on_delete=models.PROTECT)
    employees = models.ManyToManyField(to='self', blank=True)
    advisors = models.ManyToManyField(to="patients.Patients", blank=True)
...
class ProcedureCatalog(TimeStampedModel):
    ...
    taxes = models.ManyToManyField(to=Taxes, related_name="procedure_normal_tax", blank=True)
    state_taxes = models.ManyToManyField(to=Taxes, related_name="procedure_other_state_tax", blank=True)
    is_active = models.BooleanField(default=True)
...
class LabPanel(TimeStampedModel):
    ...
    margin = models.ForeignKey(ProductMargin, blank=True, null=True, on_delete=models.PROTECT)
    cost = models.IntegerField(blank=True, null=True)
    tests = models.ManyToManyField(to=LabTestCatalog, blank=True)
    is_active = models.BooleanField(default=True)
...
class PrescriptionTemplate(TimeStampedModel):
    practice = models.ForeignKey(Practice, blank=True, null=True, on_delete=models.PROTECT)
    name = models.CharField(max_length=1024, blank=True, null=True)
    drugs = models.ManyToManyField(to=DrugCatalogTemplate, blank=True)
    ...
    advice_data = models.ManyToManyField(to=Advice, blank=True)
    is_active = models.BooleanField(default=True)
...
class BedBookingPackage(TimeStampedModel):
    ...
    taxes = models.ManyToManyField(to=Taxes, related_name="bed_normal_tax", blank=True)
    state_taxes = models.ManyToManyField(to=Taxes, related_name="bed_other_state_tax", blank=True)
...
class MedicineBookingPackage(TimeStampedModel):
    ...
    name = models.CharField(max_length=1024, blank=True, null=True)
    description = models.CharField(max_length=1024, blank=True, null=True)
    taxes = models.ManyToManyField(to=Taxes, related_name="medicine_normal_tax", blank=True)
    state_taxes = models.ManyToManyField(to=Taxes, related_name="medicine_other_state_tax", blank=True)
...
class PermissionGroup(TimeStampedModel):
    ...
    permissions = models.ManyToManyField(to=Permissions, blank=True)
