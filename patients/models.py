...
class Patients(TimeStampedModel):
    ...
    practices = models.ManyToManyField(to=PersonalDoctorsPractice, blank=True)
...
class PatientProcedure(TimeStampedModel):
    ...
    date = models.DateField(null=True, blank=True)
    is_active = models.BooleanField(default=True)
    treatment_plans = models.ManyToManyField(to=PatientTreatmentPlans, blank=True)
...
class PatientFile(TimeStampedModel):
    ...
    patient = models.ForeignKey(Patients, blank=True, null=True, on_delete=models.PROTECT)
    is_active = models.BooleanField(default=True)
    file_tags = models.ManyToManyField(to=Filetags, blank=True)
...
class PatientPrescriptions(TimeStampedModel):
    practice = models.ForeignKey(Practice, blank=True, null=True, on_delete=models.PROTECT)
    patient = models.ForeignKey(Patients, blank=True, null=True, on_delete=models.PROTECT)
    drugs = models.ManyToManyField(to=PatientInventory, blank=True)
    labs = models.ManyToManyField(to=LabTestCatalog, blank=True)
    doctor = models.ForeignKey(PracticeStaff, blank=True, null=True, on_delete=models.PROTECT)
    date = models.DateField(null=True, blank=True)
    ...
    advice_data = models.ManyToManyField(to=PatientAdvice, blank=True)
...
class ProcedureCatalogInvoice(TimeStampedModel):
    ...
    default_notes = models.TextField(null=True, blank=True)
    taxes = models.ManyToManyField(to=Taxes, blank=True)
    is_active = models.BooleanField(default=True)
    doctor = models.ForeignKey(PracticeStaff, blank=True, null=True, on_delete=models.PROTECT)
...
class Reservations(TimeStampedModel):
    ...
    medicines = models.ManyToManyField(to=MedicineBooking, blank=True)
    other_diseases = models.ManyToManyField(to=OtherDiseases, blank=True)
...
class PatientInvoices(TimeStampedModel):
    ...
    procedure = models.ManyToManyField(to=ProcedureCatalogInvoice, blank=True)
    inventory = models.ManyToManyField(to=InventoryCatalogInvoice, blank=True)
    prescription = models.ManyToManyField(to=PatientPrescriptions, blank=True)
...
class ReturnPayment(TimeStampedModel):
    ...
    invoice = models.ForeignKey(PatientInvoices, blank=True, null=True, on_delete=models.PROTECT)
    procedure = models.ManyToManyField(to=ProcedureCatalogReturn, blank=True)
    inventory = models.ManyToManyField(to=InventoryCatalogReturn, blank=True)
    notes = models.CharField(max_length=2000, blank=True, null=True)
...
class PatientPayment(TimeStampedModel):
    ...
    invoices = models.ManyToManyField(to=InvoiceDetails, blank=True)
    bank = models.CharField(max_length=200, blank=True, null=True)
...
class PatientWallet(TimeStampedModel):
    patient = models.OneToOneField(to=Patients, unique=True, null=True, on_delete=models.PROTECT)
...
class PatientsPromoCode(TimeStampedModel):
    practice = models.ForeignKey(Practice, blank=True, null=True, on_delete=models.PROTECT)
    patients = models.ManyToManyField(to=Patients, blank=True)
