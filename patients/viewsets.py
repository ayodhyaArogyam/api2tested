...
from apibackend.constants import CONST_CANCELLED, CONST_GLOBAL_PRACTICE, CONST_PATIENT_DATA, CONST_DOCTOR_DATA, \
...
class PatientViewSet(ModelViewSet):
    ...
    def allopath(self, request, *args, **kwargs):
        if request.method == "GET":
            ...
            return response.Ok(create_update_multiple_record(request.data.copy(), PatientAllopathicMedicinesSerializer,
